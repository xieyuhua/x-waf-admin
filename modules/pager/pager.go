...
func (this *Pager) firstPage() string {
	if this.CurPage == 1 {
		return "<a style='margin: 5px;'>首页</a>"
	}
	return "<a style='margin: 5px;' href='" + this.Url + "/1'>首页</a>"
	return fmt.Sprintf("<a style='margin: 5px;' href='%s/1'>首页</a>", this.Url)
}
...
func (this *Pager) endPage() string {
	if this.CurPage == this.AllPage {
		return "<a style='margin: 5px;'>尾页</a>"
	}
	return fmt.Sprintf("<a style='margin: 5px;' href='%s/%d'>尾页</a>", this.Url, this.AllPage)
}
...
func (this *Pager) prevPage() string {
	if this.CurPage <= 1 {
		return "<a style='margin: 5px;'>上一页</a>"
	}
	return fmt.Sprintf("<a style='margin: 5px;' href='%s/%d'>上一页</a>", this.Url, this.CurPage-1)
}
...
func (this *Pager) nextPage() string {
	if this.CurPage >= this.AllPage {
		return "<a style='margin: 5px;'>下一页</a>"
	}
	return fmt.Sprintf("<a style='margin: 5px;' href='%s/%d'>下一页</a>", this.Url, this.CurPage+1)
}
...
func (this *Pager) nbPage(nb int) string {
	if nb == this.CurPage {
		return fmt.Sprintf("<a style='margin: 5px;' class='current' href='%s/%d'>%d</a>", this.Url, nb, nb)
	}
	return fmt.Sprintf("<a style='margin: 5px;' href='%s/%d'>%d</a>", this.Url, nb, nb)
}
